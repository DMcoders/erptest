                                        ...
                                        <#if opaList?? && opaList?size gt 0>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>${opa.opaCount!}</td>
                                                    <td>${opa.opaDate!}</td>
                                                    <td><a href="#" style="color:#3e8eea" onclick="detail('${opa.orderName!}','${opa.bedNumber!}')">详情</a>&nbsp;&nbsp;<a href="#" style="color:#3e8eea;" onclick="deleteOPA(${opa.opaID?c})">删除</a></td>
                                                </tr>
                                                </#list>
                                            </tbody>
                                        <#else>
...
<script src="/js/opaMsg/opa.js?t=201904102212"></script>
