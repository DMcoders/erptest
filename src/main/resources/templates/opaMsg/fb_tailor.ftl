                            ...
                            <section class="panel panel-default">
                                <div class="panel-body" style="text-align: left;">
                                    ...
                                    <#--<div class="row" style="font-family: PingFangSC-Semibold, sans-serif;margin-bottom: 15px;">-->
                                        ...
                                        <#--</div>-->
                                    <#--</div>-->
                                    <div style="text-align: center;font-family: PingFangSC-Semibold,sans-serif;overflow-x: auto;overflow-y: auto;max-height: 400px">
                                        <table class="table table-striped" id="tailorTable" style="width:1500px">
                                            ...
                                            <tr bgcolor="#ffcb99" style="color: black;">
                                                ...
                                                <th style="width: 3%;text-align:center;font-size:14px">序号</th>
                                                ...
                                                <th style="width: 3%;text-align:center;font-size:14px">床号</th>
                                                <th style="width: 3%;text-align:center;font-size:14px">数量</th>
                                                <th style="width: 3%;text-align:center;font-size:14px">扎号</th>
...
<script src="/js/opaMsg/tailor.js?t=201904072112"></script>
