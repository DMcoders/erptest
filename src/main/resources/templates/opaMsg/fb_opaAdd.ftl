        ...
        <div style="overflow-x: auto;overflow-y:auto;">
            ...
            <table style="border-collapse:separate;border-spacing: 10px;width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <input id="customerName" class="form-control" style="margin-bottom: 15px;width: 100%;border-top: none;border-right: none;border-left: none;">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input id="destination" class="form-control" style="margin-bottom: 15px;width: 100%;border-top: none;border-right: none;border-left: none;">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label class="control-label" style="margin-bottom: 15px;text-align: right;">出厂数量</label>
                    </td>
                    <td>
                        <input id="opaCount" class="form-control" style="margin-bottom: 15px;width: 100%;border-top: none;border-right: none;border-left: none;">
                    </td>
                </tr>
                <tr>
                    <td>
