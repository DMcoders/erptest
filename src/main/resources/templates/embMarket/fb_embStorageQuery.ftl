                    ...
                    <div class="panel-body">
                        <div class="row" style="margin-bottom: 10px">
                            ...
                            <div class="col-md-2" style="padding:0;margin-left: 30px;">
                                ...
                                <input type="text" id="colorName" class="form-control" placeholder="请输入颜色" style="width:70%;">
                            </div>
                            <div class="col-md-2" style="padding:0;margin-left: 20px;">
                                <span class="font-bold">床次：</span>
                                <input type="text" id="bedNumber" class="form-control" placeholder="请输入床次" style="width:70%;">
                            </div>
                            <div class="col-md-2" style="padding:0;margin-left: 20px;">
                                <span class="font-bold">尺码：</span>
                                <input type="text" id="sizeName" class="form-control" placeholder="请输入尺码" style="width:70%;">
                            </div>
...
<script src="/js/embMarket/embStorageQuery.js?t=201904071512"></script>
